...
Предыдущая версия была под ElasticSearch (8.1.3), находится здесь https://github.com/nickyat/elasticsearch-analysis-morphology.
...
```
# Dockerfile
Образ оригинального elasticsearch 8.3.3 с шагом установки плагина analysis-morphology

# Maven 
тесты не реализованы, собирать
```mvn clean package -Dmaven.test.skip=true```
и далее копировать полученный /target/releases/elasticsearch-analysis-morphology-8.3.3.zip в существующий кластер и устанавливать через bin/elasticsearch-plugin install file:elasticsearch-analysis-morphology-8.3.3.zip
